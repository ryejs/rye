Rye.define('Util', function(){
    ...
    function applyRight (context, fn, applyArgs, cutoff, applyLeft) {
        if (typeof fn === 'string') {
            fn = context[fn]
        }
        return function () {
            ...
            if (applyArgs) {
                args = applyLeft ? applyArgs.concat(args) : args.concat(applyArgs)
            }
    ...
    function applyLeft (context, fn, applyArgs, cutoff) {
        return applyRight(context, fn, applyArgs, cutoff, true)
    }
