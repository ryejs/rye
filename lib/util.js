Rye.define('util', function(){
    ...
    // element, text, document, fragment and window
    function isNode (element) {
        return element && [1, 3, 9, 11].indexOf(element.nodeType) >= 0 || element === window
    }
    ...
    function bindMethod (obj, method, args_length) {
        return function(){
            return obj[method].apply(obj, [].slice.call(arguments, 0, args_length))
        }
    }
